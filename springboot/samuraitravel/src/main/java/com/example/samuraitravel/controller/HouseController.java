...
public class HouseController {
    ...
    public String show(@PathVariable(name = "id") Integer id, Model model, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
        ...
        boolean userAlreadyFavorited = false;
        Favorite favorite = null;
        
        if (userDetailsImpl != null) {
        	User user = userDetailsImpl.getUser();
        	userAlreadyReviewed = reviewService.userAlreadyReviewed(house, user);
        	userAlreadyFavorited = favoriteService.userAlreadyFavorited(house, user);
        ...
        model.addAttribute("userAlreadyFavorited", userAlreadyFavorited);
